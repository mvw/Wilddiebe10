...
%\begin{figure}[ht]
%	\centering
%		\includegraphics[scale=0.8]{mypic.jpg} 
%	\caption[caption im verzeichnis]{caption unter dem bild}
%	\label{img:mypic}
%\end{figure}

% GLOSSAR WORD BEISPIEL
...
% use courier font in listings
\lstset{basicstyle=\footnotesize\ttfamily,breaklines=true}
%\lstset{framextopmargin=50pt,frame=bottomline}

% source code listings neat like in books
 \lstset{
...
%\begin{lstlisting}[label=code:labelname,caption=Auszug aus datei/von\_gestern]
%if (a=b) then x:=0;
%\end{lstlisting}
...
\cfoot{\thepage\ von \ \protect\pageref{LastPage}} % Bottom center footer
...
{
  name=Code,
  description={Hier weniger im Sinne von Programmcode, sondern Konfigurations-Code (Inhalt von Konfigurations-Dateien) benutzt}
}
...
\vfill
\begin{center}
\includegraphics[scale=0.5]{0705.png} 
\end{center}
...
Unser Dank gilt unseren Familien und Freunden, die uns den Rücken gestärkt haben, als wir uns - statt uns mit ihnen zu beschäftigen - intensiv mit akademischen Fragen auseinander gesetzt haben, weil wir uns zwei Dinge sehnlichst wünschen: Erstens, Akademiker zu sein. Und zweitens, dass dem Thema IT-Sicherheit in unserem Studium die Bedeutung zugemessen wird, welche dieses durch die Entwicklungen der letzten 50 Jahre in der Realität längst hat: Schon seit langem geht es nicht mehr um die Frage, ob IT-Sicherheit wichtig ist - sonder darum, wie sie richtig gemacht wird.
...
Das spannendste an diesem Projekt war für uns natürlich die Frage nach der IT Sicherheit. Sie steht im Spannungsfeld zwischen notwendiger ganzheitlicher Betrachtung des Themas und dem beschränkten Auftrag, 2 Dateiserver bereit zu stellen.\\
...
\begin{figure}[ht]
	\centering
		\includegraphics[scale=0.8]{kanbanboard.jpg} 
...
\begin{figure}[hbt!]
	\centering
		\includegraphics[scale=1]{si.png} 
...
Außerdem werden die erlauben Gegenstellen durch Überprüfung der Zertifikats-CNs festgelegt.
...
\begin{figure}[!htbp]
	\centering
		\includegraphics[scale=0.75]{syntaxchecks.jpg} 
...
\begin{figure}[!htbp]
	\centering
		\includegraphics[scale=0.75]{travisci.jpg} 
...
\begin{minipage}{\textwidth}
\begin{center}
\captionof{table}{Begriffsdefinition in diesem Projekt}
