...
Dieser Absatz ist ein Kontrollabschnitt, der sicher stellen soll, dass die
vorliegende Projektdokumentation auch tatsächlich von allen Beteiligten
gewissenhaft gelesen wurde. Der Verifikationscode lautet hier ''Able Archer
83''.
